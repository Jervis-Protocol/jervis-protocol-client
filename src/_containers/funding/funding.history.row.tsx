...
const FundingHistoryRow = (props: IFundingHistoryRowState) => {
    ...
    return (
        <div className="row border-bottom pt-3">
            <p className="col-6 col-md-3">{getDate(history.createdAt)}</p>
            <p className="col-6 col-md-3 text-center">{history.value} {networkInfo[state.networkId].symbol}</p>
            <p className="col-12 col-md-6 text-break">
