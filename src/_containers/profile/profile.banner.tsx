...
const ProfileBannerComponent = () => {
    ...
    return (
        <div className="row my-7" data-aos="fade-up" data-aos-delay="200">
            ...
            <div className="col-md-9 col-12 mt-md-10 mt-4">
                <h4 className="col-1 text-center text-uppercase">{user!.nickname}</h4>
                { auth === true && <div className="col-2 text-start"><Link to={"/edit"} state={{user: user!}} className="btn btn-sm text-secondary height-30 py-0 border-bottom border-3 border-dark">Edit</Link></div> }
            </div>
        </div>
    )
}
